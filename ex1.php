...
<?php
    if(!isset($telefone)){    
        ...
        $terceiroDigito = $telefone[2];
        $aCobrar = intval(substr($telefone,2,2));
        if(strlen($telefone)==10 || strlen($telefone)==11){
            if(is_numeric($telefone)){
                if(in_array($ddd, $ddds)){
                    if(strlen($telefone)==11 && $terceiroDigito == 9 && $aCobrar !== 90){
                        echo "<p>(".substr($telefone, 0, 2).") ".substr($telefone, 2, 5)."-".substr($telefone, 7, 10)."</p>";
                        }else if(strlen($telefone)==10 && $terceiroDigito>= 2 && $terceiroDigito<= 8){echo "<p>(".substr($telefone, 0, 2).") ".substr($telefone, 2, 4)."-".substr($telefone, 6, 9)."</p>";}else{echo "<p>Número inválido</p>";}
                }else{echo "<p>Número inválido</p>";}
            }else{echo "<p>Número inválido</p>";}
        }else {echo "<p>Número inválido</p>";}
    }else {echo "<p>Número inválido</p>";}
?>    
